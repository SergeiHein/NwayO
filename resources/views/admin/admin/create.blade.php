...
@section('content')
    <div class="main-container">
        ...
        <div>
            ...
            <form class="position-relative w-100 h-100 bg-white p-2 mt-3" method="post"
                ...
                <div class="row mx-0 pt-3 mb-3" style="padding-left: 15px;">
                    <div class="col-7">
                        ...
                        <input type="text" class="input-form" style="border-radius: 6px;" name="name"
                               value="{{old('name')}}"
                               placeholder="Name">
                ...
                <div class="row mx-0 pt-3 mb-3" style="padding-left: 15px;">
                    <div class="col-7">
                        ...
                        <input type="text" class="input-form" style="border-radius: 6px;" name="email"
                               value="{{old('email')}}"
                               placeholder="Email">
                ...
                <div class="row mx-0 pt-3 mb-3" style="padding-left: 15px;">
                    <div class="col-7">
                        <label for="" class="label-form mb-3" style="font-size: 17px!important;">Confirm
                            Password</label>
                ...
                <div class="ml-4 pl-1 mt-4">
                    <button type="submit" class="btn btn-danger pl-3" style="font-size: 16px!important;"
                            id="confirm-add-button"> Add Admin
                    </button>
