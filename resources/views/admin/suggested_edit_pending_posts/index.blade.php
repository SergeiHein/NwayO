...
@section('title', ' Suggested Edit Pending Posts')
...
@section('content')
    ...
    <div class="main-container">
        <header class="header pl-2">
            <nav>
                <a href="#" class="a-clear text-dark fm-roboto fs17">Suggested Edit Pending Posts</a>
                        ...
                        <tr>
                            ...
                            <td class="padding-table-row w89px">
                                <button type="button" class="btn-clear " title="Edit" id="edit-button">
                                    <a class="a-clear text-dark" href="{{route('form.confirm.suggested_edit_pending_post',['pendingPost'=> $post->id])}}">
